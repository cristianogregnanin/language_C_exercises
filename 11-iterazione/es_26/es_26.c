 ...
 */
double calcola_distanza_percorsa(double distanza, int num_spostamenti)
{
    ...
    {
        distanza_rimanente /= 2;
        distanza_coperta += distanza_rimanente;
    }

    return distanza_coperta;
}
...
int main(int argc, char *argv[])
{
    ...
    double distanza_effettiva = calcola_distanza_percorsa(distanza, num_spostamenti);

    printf("Distanza effettivamente coperta dopo %d spostamenti: %.10f\n", num_spostamenti, distanza_effettiva);
